...
ColoredUncertainty::ColoredUncertainty()
...
void ColoredUncertainty::setMean( const Eigen::Vector2d& mean )
{
    Eigen::Vector3d m;
    m << mean, 0.0;
...
void ColoredUncertainty::setMean( const Eigen::Vector3d& mean )
{
...
void ColoredUncertainty::setCovariance( const Eigen::Matrix2d& cov )
{
...
void ColoredUncertainty::setCovariance( const Eigen::Matrix3d& cov )
{
    // get the rotation and scaling of the ellipsoid from the covariance matrix
...
void ColoredUncertainty::addEllipse( int axis )
{
...
void ColoredUncertainty::addSamples()
{
